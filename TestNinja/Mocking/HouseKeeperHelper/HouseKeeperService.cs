...
namespace TestNinja.Mocking.HouseKeeperHelper
{
    public class HouseKeeperService
    {
        ...
        {
            var housekeepers = _repository.GetHouseKeepers();
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                var statementFilename = _statementGenerator
                    .SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
                ...
                {
                    _msgBox.Show(e.Message, string.Format("Email failure: {0}", emailAddress),
